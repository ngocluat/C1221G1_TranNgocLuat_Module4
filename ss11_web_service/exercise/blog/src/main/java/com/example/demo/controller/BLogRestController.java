...
public class BLogRestController {
    ...
    public ResponseEntity<Page<Blog>> getLisstBlog(Pageable pageable, @RequestParam Optional<String> name) {
        String key = name.orElse("");
        Page<Blog> allBlogs = iBlogService.findAllByNameBlogContaining(key, pageable);
