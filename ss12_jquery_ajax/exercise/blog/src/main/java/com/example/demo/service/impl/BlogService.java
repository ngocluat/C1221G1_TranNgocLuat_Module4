...
//    }
    ...
    @Override
    public Page<Blog> findByNameBlogContainingAndAuthorContaining(String name, String author, Pageable pageable) {
        return iBlogRepository.findByNameBlogContainingAndAuthorContaining(name , author,pageable);
    }
